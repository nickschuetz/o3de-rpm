...
flowchart TB
    ...
    subgraph TEST["Test gate (community-shared)"]
        ...
        T6["tests/multiplayersample-build-test.sh<br/>Tier 9: full MultiplayerSample build<br/>+ AP batch + launcher-load smoke<br/>(post-load gameplay blocked by<br/>o3de/o3de#19780 startmenu crash;<br/>opt-in; ~60-90 min cold,<br/>~3-10 min warm)"]
