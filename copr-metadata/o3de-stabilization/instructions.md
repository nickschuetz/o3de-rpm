...
- **CS10 (CentOS Stream 10) chroot** -- with_opts gap fully closed 2026-05-14; CS10 now runs the same 18 swap activations as F44 + rawhide. CS10's first stabilization build with the full pack will validate the new flags on the next triggered build.
