...
- **Stage 1 13-pack** -- engine links to system `expat`, `freetype`, `liblz4`, `libpng`, `mikkelsen` (`libmikktspace.so.0`), `openexr` (+ `imath`), `zlib`, `lua-libs`, `poly2tri`, `assimp`, `sqlite-libs`, `libsamplerate`, **`google-benchmark`** instead of bundled copies. 12-pack subset promoted to this channel 2026-05-11 (build 10444167); the 13th swap (`system_googlebenchmark`) promoted 2026-05-12 alongside the Patch0012 v2 AssetBuilder watchdog fix.
