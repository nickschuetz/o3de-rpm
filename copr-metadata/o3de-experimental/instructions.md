...
- **Stage 1 6-pack** — engine links to system `expat`, `freetype`, `liblz4`, `libpng`, `mikkelsen` (`libmikktspace.so.0`), `zlib` instead of bundled copies. Validated end-to-end on 2026-05-05: build 10426632 succeeded on F44 + rawhide, CI passed Tiers 1+2+4+6 on both chroots. Find-shim refactor (commits 92bde6e / cba5059 / 6b14ffa / 0ca58e8 for the original 4 ZLIB-class swaps; commit `4b0893a` for lz4) follows a uniform pattern: direct find_path/find_library, no stock-cmake-include, real INTERFACE IMPORTED 3rdParty target — keeps O3DE's runtime-dependency walker happy.
