...
|---|---|---|---|---|
| **DirectXShaderCompilerDxc** | 1.8.2505.1-o3de-rev3 | NCSA + Apache-2.0 (LLVM exception) | No | License-clean rebuild from upstream `o3de/DirectXShaderCompiler` at tag `release-1.8.2505.1-o3de`. PoC SRPM submitted as `o3de-dxc-spirv-poc` build 10433445 (in flight 2026-05-07). Engine shells out to `dxc` binary at shader-compile time per Nick_L (sig-build, 2026-05-05). See `FEDORA_ROADMAP.md` § "License-clean DXC rebuild" + `project_dxc_binary_only_dependency.md` memory. |
