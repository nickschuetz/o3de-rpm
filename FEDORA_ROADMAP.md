...
| 1 -- System swap migration | **13-pack ACTIVE in `hellaenergy/o3de-stabilization` COPR (promoted 2026-05-12/13 in build 10452477)**: zlib, freetype, libpng, expat, lz4, mikkelsen, openexr, poly2tri, lua, assimp, sqlite, libsamplerate, googlebenchmark. Patch0010 + Patch0011 cover Lua 5.5 forward-compat (rawhide); engine compiles green on Lua 5.5. Patch0012 v2 (AssetBuilder parent-death watchdog) also active in the o3de-stabilization COPR channel as of 10452477. |
