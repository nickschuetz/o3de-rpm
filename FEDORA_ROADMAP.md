...
| Stage | Status |
|---|---|
| 0 -- COPR distribution | Active. Four engine channels (o3de stable, o3de-stabilization community, o3de-snapshot dev-branch, o3de-experimental Stage 1 in-flight). Versioned multi-install architecture live (o3de2605 etc., /opt/O3DE/<v>/). o3de2605-devel subpackage split landed 2026-05-04. **CS10 chroot achieved first-ever successful engine build 2026-05-12** (build 10450340) via gcc-toolset-15-libatomic-devel BR; bundled-3p everywhere since CS10 with_opts still empty. |
| 1 -- System swap migration | **13-pack ACTIVE in stabilization (promoted 2026-05-12/13 in build 10452477)**: zlib, freetype, libpng, expat, lz4, mikkelsen, openexr, poly2tri, lua, assimp, sqlite, libsamplerate, googlebenchmark. Patch0010 + Patch0011 cover Lua 5.5 forward-compat (rawhide); engine compiles green on Lua 5.5. Patch0012 v2 (AssetBuilder parent-death watchdog) also active in stabilization as of 10452477. |
| 2 -- Binary/library deps not in Fedora | **Three Stage 2 PoCs ALL GREEN as of 2026-05-08**: o3de2605-spirv-cross (binary shellout), o3de2605-dxc-spirv (binary shellout), o3de2605-mcpp-az (library link, first of its kind). All three swaps active in experimental; not yet promoted to stabilization. |
...
- **O3DE 26.05.0 release date set: 2026-05-27** (sig-release chair Nick, decision 2026-05-12). 15-day pre-release window. Triggers post-release packaging work: snapshot pin re-pin to release tag, Patch0007/Patch0008 retirement re-check after stabilization absorbs upstream merges, COPR rebuild from release tag, tester announcement. Pre-release sweep agent scheduled for 2026-05-25 09:00 CDT. Memory: `project_2605_release_date.md`.
