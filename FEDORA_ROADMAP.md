...
- `hellaenergy/o3de-development` — Sunday-cron builds from `o3de/development` (renamed from `o3de-snapshot` 2026-05-23 to make the branch-tracking intent explicit; auto-refreshed via `.github/workflows/snapshot-development.yml`). For an in-progress migration ref (e.g. qt6), a dedicated COPR project per branch (e.g. `o3de-development-qt6`).
